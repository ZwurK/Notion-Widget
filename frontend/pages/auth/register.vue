<template>
  <div class="flex flex-col items-center justify-center h-screen">
    ...
    <form @submit.prevent="handleRegister" class="w-1/3">
      <div class="mb-4">
        <label class="block mb-2 text-sm font-bold" for="name">Username:</label>
        <input v-model="username" id="name" class="w-full px-3 py-2 border rounded" required />
      </div>
      <div class="mb-4">
      ...
      <button type="submit" class="px-4 py-2 bg-blue-500 text-white rounded hover:bg-blue-700">Register</button>
    </form>
